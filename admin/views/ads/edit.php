  ...
  <div class="col-md-6 col-lg-4">
    <div class="card bg-primary bg-gradient text-white">
      <div class="card-body text-center">
        <h2 class="card-title text-uppercase">Urejanje</h2>
        <form action="register.php" method="POST">
          ...
          <div class="mb-3">
            ...
            <input type="password" class="form-control" name="password" id="password" id="username" required>
          </div>
          <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <input type="number" class="form-control" name="postNumber" id="postNumber" min="1000" max="9999" value="<?php echo $user->postNumber; ?>">
          </div>
          <div class="mb-3">
          ...
          <div class="mb-3">
            <input class="btn btn-light" type="submit" name="submit" value="POTRDI">
          </div>
